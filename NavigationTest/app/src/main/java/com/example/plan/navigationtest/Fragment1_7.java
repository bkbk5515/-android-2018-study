...
public class Fragment1_7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ViewGroup rootview = (ViewGroup) inflater.inflate(R.layout.fragment1_7, container, false);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(nullcheck == 0) {
                    ...
                    saveeditor.putString("7", replaceString);
                    saveeditor.commit();
