...
public class RecyclerViewAdapter03 extends RecyclerView.Adapter<RecyclerViewAdapter03.CustomViewHolder> {

    private ArrayList<RecyclerViewItem03> mList;
    ...
    public RecyclerViewAdapter03(ArrayList<RecyclerViewItem03> list) {
        this.mList = list;
    }
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_main_recyclerview03, viewGroup, false);
