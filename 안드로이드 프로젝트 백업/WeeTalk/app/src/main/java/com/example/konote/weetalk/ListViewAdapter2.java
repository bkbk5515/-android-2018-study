...
public class ListViewAdapter2 extends BaseAdapter {
    ...
    public ArrayList<ListViewItem2> listViewItemList2 = new ArrayList<ListViewItem2>() ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView userID = (TextView) convertView.findViewById(R.id.textView1) ;
        ...
        // 아이템 내 각 위젯에 데이터 반영
        userID.setText(listViewItem2.getUserID());
    ...
    public void addItem(String _userID) {
