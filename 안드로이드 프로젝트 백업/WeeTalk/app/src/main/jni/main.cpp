#include <jni.h>
#include "com_example_konote_weetalk_OpenCVActivity.h"
...
//Java_com_example_konote_opencv_103_MainActivity
...
Java_com_example_konote_weetalk_OpenCVActivity_detect(JNIEnv *env, jclass type,
                                                                       ...
                                                                       jlong matAddrResult)
{
    ...
    cvtColor(img_input, img_gray, COLOR_BGR2GRAY);//이부분
    ...
    for (int i = 0; i < faces.size(); i++) {
        ...
        for ( size_t j = 0; j < eyes.size(); j++ )
        {
            ...
            circle( img_result, eye_center, radius, Scalar( 255, 0, 0 ), 0, 8, 0 );
        }
    }
