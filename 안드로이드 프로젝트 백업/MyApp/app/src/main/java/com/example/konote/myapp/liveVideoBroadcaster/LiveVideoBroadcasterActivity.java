package com.example.konote.myapp.liveVideoBroadcaster;
...
import com.example.konote.myapp.R;
...
import static com.example.konote.myapp.MainActivity.RTMP_BASE_URL;
...
public class LiveVideoBroadcasterActivity extends AppCompatActivity {
                    ...
                    new AsyncTask<String, String, Boolean>() {
                        ...
                        protected void onPostExecute(Boolean result) {
                            ...
                            if (result) {
                                ...
                                Snackbar.make(mRootView, "stream_not_started", Snackbar.LENGTH_LONG).show();
    ...
    public void triggerStopRecording() {
        if (mIsRecording) {
            mBroadcastControlButton.setText("stream_not_started");
